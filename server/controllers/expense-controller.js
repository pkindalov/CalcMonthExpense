                        ...
                        .then(user => {
                          ...
                          Category
                            ...
                            .then(category => {
                              ...
                              category.expenses = category.expenses.concat(expense._id);
                              category.save();
                              ...
                              if (checkCategoryExists < 0) {
                                ...
                                expense.categories = expense.categories.concat(category._id);
                                expense.save();
                              }
                            })
                        })
      ...
      .then(expenses => {
        expenses.forEach(expense => {
          ...
          expense.products.forEach(expenseProductID => {
            ...
            productsPromises = productsPromises.concat(productQuery);
